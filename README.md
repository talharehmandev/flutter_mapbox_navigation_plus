...
> [!NOTE]
> This is a community-maintained fork of the original [flutter_mapbox_navigation](https://pub.dev/packages/flutter_mapbox_navigation) package by [eopeter](https://pub.dev/publishers/eopeter.com/packages). It has been updated to support Flutter 3.x and the latest Android Gradle configurations. The source code for this fork can be found at [github.com/talharehmandev/flutter_mapbox_navigation_plus](https://github.com/talharehmandev/flutter_mapbox_navigation_plus).
